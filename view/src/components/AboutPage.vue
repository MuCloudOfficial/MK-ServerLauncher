...
<template>
  <el-card>
    ...
    <div>
      <span>If you like MK-ServerLauncher<sup>MPE</sup> and get the latest news, please visit <a class="underline" href="https://www.github.com/MuCloudOfficial/MK-ServerLauncher">Github Repository<el-icon size="13">
      ...
      </a> and star the Project! Thanks &heartsuit;~</span>
    </div>
    <el-divider content-position="left" class="border-2">
      Project News
    </el-divider>
    ...
    or Mu_Cloud's Social Medias for more related News.
  </el-card>
</template>
